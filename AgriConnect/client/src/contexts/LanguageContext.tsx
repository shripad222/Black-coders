...
const initialKeys = [
  ...
  "Live Updates",
      "🌾 Wheat prices up in Pune by ₹5/quintal • 🌶️ Chilli demand high in Belgaum • 🧅 Onion export news from Nashik • 🍅 Tomato season peak in Goa",  "I'm listening... How can I help?",
  "Speak in Your Voice",
