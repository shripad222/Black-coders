        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-lg">
              रिअल-टाइम मार्केट किंमती, थेट खरेदीदार आणि आवाजावर चालणारा सहाय्यक. 
              आपल्या प्रादेशिक भाषेत व्यवहार करा.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t">
              <div>
                ...
                <div className="text-sm text-muted-foreground">शेतकरी</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-secondary">200+</div>
                <div className="text-sm text-muted-foreground">मंडी</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-accent">24/7</div>
                <div className="text-sm text-muted-foreground">सपोर्ट</div>
              </div>
            </div>
          </div>
